              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="mt-1 text-gray-600">info@insurespectre.com</p>
                  </div>
                </div>
          ...
          <div className="md:col-span-3">
            {isSubmitted ? (
              <div className="bg-green-50 p-6 rounded-lg text-center">
                ...
                <p className="text-gray-600 mb-4">Your message has been sent successfully. We'll be in touch with you shortly.</p>
                <button 
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <button
                      ...
                      className={`w-full inline-flex justify-center items-center px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-indigo-700 hover:bg-indigo-800 ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
                    >
                      {isSubmitting ? (
                        <>
